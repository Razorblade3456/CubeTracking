...
function App() {
  ...
  const toggleComplete = (id) => {
    ...
    showToast('Task armed. Press play to zap bug.');
  };
      ...
      <main className="list-section">
        <section className="todo-card">
          <div className="card-heading">
            <h2>Habits / To-Dos</h2>
            <p>Track missions, add optional notes, and keep momentum with one-tap complete and undo.</p>
          </div>
          ...
          <div className="list-group">
            <h3>Open / Armed ({activeItems.length})</h3>
          ...
          <div className="list-group completed">
            ...
            {completedItems.length === 0 ? (
              <p className="empty-state">Arm a task, then press play to zap it.</p>
            ) : (
        ...
        {isEditing ? (
          ...
          <>
            ...
            <small>
              ...
              {item.queued && !item.completed ? ' · Armed for next zap' : ''}
            </small>
          </>
        )}
      </div>
        ...
        {isEditing ? (
          ...
          <>
            <button className="ghost" type="button" onClick={() => onToggleComplete(item.id)}>
              {item.completed || item.queued ? 'Undo' : 'Arm'}
            </button>
